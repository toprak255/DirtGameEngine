//  Modified version of Igor Kroitor's gjk algorithm implementation.
...
int dgm::collision(vec2* vertices1, vec2* vertices2) {
    /*
    vec2 vertices1 = *vertices1p;
    vec2 vertices2 = *vertices2p;
    */
    /*
    vec2 vertices1[] = {
        { -1.0f, -1.0f },
